...
* Our model is very poor at estimating B/Bmsy values lower than 0.5, and in fact we generally estimate excessively high values for those stocks
* Our model is not better or worse at estimating B/Bmsy for bigger or smaller fisheries
* Our model overestimates F/Fmsy by on average 50%
* Our model on average underestimates MSY by 25%
* There doesn't appear to be a significant relationship between our error in MSY and the size of the fishery
...
However, there appears to be little correlation between our error in MSY and the size of the fishery (as defined by lifetime catch, Fig.XX), suggesting that we simply underestimate MSY for most of the RAM stocks. 
