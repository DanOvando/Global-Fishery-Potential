...
data<-read.csv(paste(ResultFolder,'Lumped Projection DataAll Stocks Country Upsides.csv',sep=''))
data2<-read.csv(paste(ResultFolder,'Lumped Projection DataOverfish Only Country Upsides.csv',sep=''))
