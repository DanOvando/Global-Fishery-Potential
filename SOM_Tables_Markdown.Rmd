...
## NEI
nei<-read.csv('Results/TUNA TEST/Data/UnLumped Projection DataAll Stocks Profit Upsides From NEIs.csv',stringsAsFactors=F)
...
costratio<-read.csv('Results/TUNA TEST/Data/Cost_Revenue_Ratios_ISSCAAP.csv',stringsAsFactors=F)

# Cost per ton
costperton<-read.csv('Results/TUNA TEST/Data/CostPerTon_Ratios_ISSCAAP.csv',stringsAsFactors=F)
...
fig3<-read.csv('Results/TUNA TEST/Data/Fig3data_Profit2050.csv',stringsAsFactors=F)
...
## RAM stock list
ram<-read.csv('Results/TUNA TEST/Data/Ram Stock List.csv',stringsAsFactors=F)
