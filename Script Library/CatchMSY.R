...
startbio    <- if(ct[1]/max(ct) < 0.5) {c(0.5,0.9)} else {c(0.3,0.6)} ## use for batch processing #SUB IN BVBMSY VALUES
...
write.csv(output2, file = paste(outfile2,'.csv',sep=''))
