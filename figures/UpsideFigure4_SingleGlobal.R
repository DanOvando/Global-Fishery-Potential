AllStocks<-read.csv("C:/Users/Cody/Desktop/UpsideData/PT figures/UnLumped Projection DataAll Stocks Country Upsides.csv")
OverfishStocks<-read.csv("C:/Users/Cody/Desktop/UpsideData/PT figures/UnLumped Projection DataOverfish Only Country Upsides.csv")
